...
contract AskMeAnything {
    ...
    function registerQuestion(string memory _username, string memory _question_string) public {
        ...
        user_questions[_username].push(Question({
            id:_id,
    ...
    function getUserQuestions(string memory _username) public view returns (Question[] memory){
        return user_questions[_username];
    }

    function addAnswer(string memory _username, uint16 _id, string memory _answer) public {
